...
# functions
def _submit(
        user_name: str, repo_name: str, tag: str, access_token: str
) -> None:
    ...
    desired_release = [
        x for x in release_response.json() if x['tag_name'] == tag
    ].pop()
    ...
    submit_response = requests.post(
        "https://zenodo.org/api/hooks/receivers/github/events/"
